    ...
    <div class="w-11/12 py-12 md:max-w-screen-xl mx-auto flex flex-col md:flex-row gap-4 md:gap-8 overflow-hidden animate-fade-up">
      ...
      <div class="flex flex-col gap-4 md:gap-6">
        ...
        <div class="flex items-center gap-4">
          <button type="button" @click="moviesStore.addToFavorites(id)" class="text-white p-2 bg-red-500 hover:scale-110 transition rounded-md w-36 flex items-center gap-2 justify-center">
            <span>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#fff" class="w-6 h-6">
